...
PDEPEND="
	...
	video_cards_freedreno?     ( >=x11-base/xorg-server-${_PV}[-minimal] )
	video_cards_geode?         ( x11-drivers/xf86-video-geode )
	video_cards_i915?          ( x11-drivers/xf86-video-intel )
	video_cards_intel?         ( >=x11-base/xorg-server-${_PV}[-minimal] )
	video_cards_mga?           ( >=x11-drivers/xf86-video-mga-1.6.5 )
	video_cards_tegra?       ( >=x11-drivers/xf86-video-nouveau-1.0.13 )
	...
	video_cards_tegra?         ( >=x11-base/xorg-server-${_PV}[-minimal] )
	video_cards_vc4?           ( >=x11-base/xorg-server-${_PV}[-minimal] )
