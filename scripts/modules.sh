...
mkdir -p /usr/local/tmp/modules-9999
mount -o loop,ro ${loopdev}p4 /usr/local/tmp/modules-9999
cp -avnr /usr/local/tmp/modules-9999/usr/lib/modules/* /usr/lib/modules/
losetup -d "${loopdev}"
umount /usr/local/tmp/modules-9999
